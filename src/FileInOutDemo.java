...
// Создание байтового потока ввода:
            FileInputStream fis=
            new FileInputStream("D://JProjects/VasilievGlava12Input_Output_Printf_WorkWithFiles/base.txt");
// Создание байтового потока вывода:
            FileOutputStream fos=new FileOutputStream("D://JProjects/VasilievGlava12Input_Output_Printf_WorkWithFiles/data.txt",true);
