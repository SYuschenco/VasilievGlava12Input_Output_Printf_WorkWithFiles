...
// Базовая директория:
        String FilePath="D:/JProjects/VasilievGlava12Input_Output_Printf_WorkWithFiles/";
...
// Создание файлового потока вывода:
            FileOutputStream fout=new FileOutputStream("D:/JProjects/VasilievGlava12Input_Output_Printf_WorkWithFiles/result.txt");
// Считывание из файла:
            int s=fin.read();
